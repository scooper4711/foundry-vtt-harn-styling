Hooks.on("init", () => {
    ...
    CONFIG.TinyMCE.font_formats = (CONFIG.TinyMCE.font_formats?CONFIG.TinyMCE.font_formats:defaultFonts) + ";BookSanity=BookSanity;NodestoCaps=NodestoCaps;ScalySans=ScalySans;ScalySansSmallCaps=ScalySansSmallCaps;Solberry=Solberry;MrJeeves=MrJeeves;Uncial Antiqua=Uncial Antiqua;Lankorian=Lankorian-Blackhand";
});
