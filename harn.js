Hooks.on("init", () => {
    ...
    let extraFonts = "BookSanity=BookSanity;NodestoCaps=NodestoCaps;ScalySans=ScalySans;ScalySansSmallCaps=ScalySansSmallCaps;Solberry=Solberry;MrJeeves=MrJeeves;Uncial Antiqua=Uncial Antiqua";
